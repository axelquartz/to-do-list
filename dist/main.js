...
class Task {
    ...
    createTask(title, description, dueDate){
        ...
        dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(), dateDay + '/' + dateMonth + '/' + dateYear);;
